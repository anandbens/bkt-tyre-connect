...
const commonBenefits = [
  ...
  "Jumpstart assistance for weak/dead battery",
...
export const plans: Plan[] = [
  {
    ...
    benefits: [
      ...
      { name: "On-spot repairs", included: true },
      { name: "Tele-assistance for minor repairs", included: true },
      { name: "Jumpstart assistance for weak/dead battery", included: true },
      { name: "On-road key lockout assistance", included: true },
      { name: "Puncture repair", included: true },
      { name: "Fuel delivery", included: true },
      { name: "Towing", included: true },
      { name: "Hotel Accommodation", included: false },
      { name: "Ambulance Assistance", included: true },
